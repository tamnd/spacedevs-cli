...
// HTTP behaviour is covered in spacedevs_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "spacedevs://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("spacedevs", "about")
	if err != nil || got.String() != "spacedevs://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want spacedevs://page/about", got.String(), err)
	}
}
