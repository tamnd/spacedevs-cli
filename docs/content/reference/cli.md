...
```
spacedevs <command> [arguments] [flags]
```

Run `spacedevs <command> --help` for the full flag list on any command. This
...
per operation you declare in `spacedevs/domain.go`.
