...
Most of these come down to network reality or how spacedevs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

spacedevs rate-limits like any public site. spacedevs already paces
...
Where a surface is gated, spacedevs reads a cookie or token you supply
...
`spacedevs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what spacedevs actually did
